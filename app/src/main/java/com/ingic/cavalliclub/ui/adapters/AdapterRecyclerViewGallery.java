...
import com.ingic.cavalliclub.fragments.FragmentGalleryPager;
...
/*                final DialogHelper dialogHelper = new DialogHelper(context);
                ...
                context.replaceDockableFragment(FragmentGalleryPager.newInstance(images, position), "FragmentGalleryPager");
            }
        });
