...
public class EntityUpcomingEvent {
    ...
    @Expose
    private List<EntityEventImage> eventImages;
    ...
    public List<EntityEventImage> getEventImages() {
        return eventImages;
    }

    public void setEventImages(List<EntityEventImage> eventImages) {
